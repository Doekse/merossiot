...
/**
 * Mocked-device tests for {@link module:controller/abilities/temp-unit-ability}.
 */

const assert = require('node:assert');
const { describe, it } = require('node:test');

const createTempUnitAbility = require('../lib/controller/abilities/temp-unit-ability');
