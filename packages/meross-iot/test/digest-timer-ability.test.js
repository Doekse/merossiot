...
/**
 * Mocked-device tests for {@link module:controller/abilities/digest-timer-ability}.
 */

const assert = require('node:assert');
const { describe, it } = require('node:test');

const createDigestTimerAbility = require('../lib/controller/abilities/digest-timer-ability');
