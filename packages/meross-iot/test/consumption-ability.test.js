...
/**
 * Mocked-device tests for {@link module:controller/abilities/consumption-ability}.
 */

const assert = require('node:assert');
const { describe, it } = require('node:test');

const createConsumptionAbility = require('../lib/controller/abilities/consumption-ability');
