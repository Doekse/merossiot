...
/**
 * Mocked-device tests for {@link module:controller/abilities/hub-ability}.
 */

const assert = require('node:assert');
const { describe, it } = require('node:test');

const createHubAbility = require('../lib/controller/abilities/hub-ability');
const { handlePushNotification } = require('../lib/controller/abilities/hub-ability');
