...
/**
 * Mocked-device tests for {@link module:controller/abilities/electricity-ability}.
 */

const assert = require('node:assert');
const { describe, it } = require('node:test');

const createElectricityAbility = require('../lib/controller/abilities/electricity-ability');
