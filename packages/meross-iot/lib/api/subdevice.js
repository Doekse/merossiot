...
/**
 * Represents subdevice information from the Meross cloud API
 *
 * This class encapsulates subdevice metadata retrieved from the Meross Meross cloud API,
 * including subdevice identification, type, vendor, and icon information.
 *
 * @class
 * @example
 * // Use fromDict() to create instances
 * const subdeviceInfo = ApiSubdeviceInfo.fromDict({
 *     subDeviceId: '12345',
 *     trueId: '67890',
 *     subDeviceType: 'ms130',
 ...
 * });
 */
class ApiSubdeviceInfo {
    /**
     * Creates an ApiSubdeviceInfo instance from a dictionary object.
     *
     ...
     * @returns {ApiSubdeviceInfo} New ApiSubdeviceInfo instance
     */
...
module.exports = ApiSubdeviceInfo;
