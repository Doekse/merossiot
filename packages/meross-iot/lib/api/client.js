...
const { MerossError, MerossAuthError, MerossApiError, MerossNetworkError, mapErrorCodeToError } = require('../exception');
...
/**
 * Meross cloud API client communication
 *
 ...
 * @class
 * @example
 * const client = new MerossApiClient({
 *     logger: console.log,
 *     timeout: 10000,
 *     enableStats: true
 * });
 ...
 */
class MerossApiClient {
    /**
     * Creates a new MerossApiClient instance
     *
     ...
     * @returns {Promise<MerossApiClient>} Authenticated HTTP client instance
     * @static
     * @example
     * const client = await MerossApiClient.fromUserPassword({
     ...
     * @param {string} [options.appVersion] - Custom AppVersion header
     * @param {string} [options.appType] - Custom AppType header
     * @returns {MerossApiClient} HTTP client instance with credentials set
     * @static
     * @example
     * const client = MerossApiClient.fromCredentials({
     *     token: 'savedToken',
     *     key: 'savedKey',
     *     userId: 'userId123',
...
module.exports = MerossApiClient;
