...
/**
 * Represents device information from the Meross cloud API
 *
 * This class encapsulates device metadata retrieved from the Meross Meross cloud API,
 ...
 * const deviceInfo = ApiDeviceInfo.fromDict({
 *     uuid: '12345',
 *     devName: 'My Device',
 *     deviceType: 'mss310',
 *     onlineStatus: 1,
...
class ApiDeviceInfo {
    ...
    static fromDict(jsonDict) {
        ...
        const instance = Object.create(ApiDeviceInfo.prototype);
